...
export const KILO_TOKENS_DARK = {
  ...
  inkSubtle: '#686660',        // Mechanical score ink (3.6:1). Gutter line numbers (01-15), inactive column headers.
...
2. **Zero Drop Shadows**: `box-shadow: none` everywhere. Depth is delivered strictly by the 4 surface tiers and 1px hairlines (`#2C2C30`).
