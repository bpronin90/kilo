...
// renders its own hosted iframe so it keeps its correct light/dark boundary.
// Under the production KUA gate (`kua` supplied) the error ink uses the readable
// on-surface `errorText` token; outside the gate (`kua` null — isolated captcha
